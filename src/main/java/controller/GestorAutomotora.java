    ...
    public JTable buscarVehiculo(String marca, String modelo){
        ...
        for(Vehiculo vehiculo1 : listaVehiculos){
            if(vehiculo1.getModelo().equals(modelo) && vehiculo1.getMarca().equals(marca)){
                String[] puesto1 = {vehiculo1.getModelo(),vehiculo1.getMarca(), String.valueOf(vehiculo1.getAño()), String.valueOf(vehiculo1.getPrecio()),vehiculo1.getColor(), String.valueOf(vehiculo1.getKilometrosRecorrido())};
